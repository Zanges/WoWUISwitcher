...
namespace WoWUISwitcher
{
    ...
    public static class SymbolicLink
    {
        ...
        ///     <c>True</c>, wenn eine bereits existierende Datei bzw. ein bereits existierender
        ///     symbolischer Link überschrieben werden soll.
        /// </param>
        ...
        /// <summary>
        ///     Gibt den Pfad eines Ordners oder einer Datei zurück wobei symbolische Links und bereit gestellte NTFS Ordner
        ///     aufgelöst wurden.
        /// </summary>
        ...
        public static string GetRealPath(string path)
        {
            ...
            var directoryHandle = CreateFile(symlink.FullName, 0, 2, IntPtr.Zero, CREATION_DISPOSITION_OPEN_EXISTING,
                FILE_FLAG_BACKUP_SEMANTICS, IntPtr.Zero); //Handle zur Datei/Ordner
        ...
        private static extern bool CreateSymbolicLink([In] string lpSymlinkFileName, [In] string lpTargetFileName,
            [In] int dwFlags);
