    ...
    class WindowHelper
    {
        ...
        public class EnumWindowsItem
        {
            ...
            private class UnManagedMethods
            {
                ...
                [DllImport("user32")]
                public extern static uint GetWindowThreadProcessId(IntPtr hwnd, out IntPtr lpdwProcessId);
                [DllImport("user32")]
            ...
            public Process Process
            {
                ...
                {
                    IntPtr processid;
                    UnManagedMethods.GetWindowThreadProcessId(this.hWnd, out processid);
        ...
        // FROM https://stackoverflow.com/questions/2825528/removing-the-title-bar-of-external-application-using-c-sharp
